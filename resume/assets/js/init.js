$(document).ready(function() {
    ...
    ***************************************************************************/
      ...
      if (event.isDefaultPrevented()) {
          ...
          formError();
          submitMSG(false, "Please enter all fields");
      } else {
      ...
      google.maps.event.addDomListener(window, 'load', init);
        function init() {
          var mapOptions = {
              ...
              center: new google.maps.LatLng(13.049696, 77.608790),
          ...
          var marker = new google.maps.Marker({
              position: new google.maps.LatLng(13.049696, 77.608790),
              map: map,
              title: '14, Sandyagappa Layout, Hebbal Kempapura, Bnagalore, India - 560024'
          });
        }
